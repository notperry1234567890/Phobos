...
public class RenderUtil implements Util {
  ...
  public static void drawGradientBlockOutline(BlockPos pos, Color startColor, Color endColor, float linewidth) {
    ...
    drawGradientBlockOutline(iblockstate.getSelectedBoundingBox((World)mc.world, pos).grow(0.0020000000949949026D).offset(-interp.x, -interp.y, -interp.z), startColor, endColor, linewidth);
  }
  ...
  public static void drawText(BlockPos pos, String text) {
    ...
    GlStateManager.disableDepth();
    GlStateManager.translate(-(Phobos.textManager.getStringWidth(text) / 2.0D), 0.0D, 0.0D);
