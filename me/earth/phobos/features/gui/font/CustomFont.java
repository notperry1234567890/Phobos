...
public class CustomFont extends CFont {
  ...
  public float drawString(String text, double xI, double yI, int color, boolean shadow) {
    double x = xI;
    double y = yI;
    if (FontMod.getInstance().isOn() && !((Boolean)(FontMod.getInstance()).shadow.getValue()).booleanValue() && shadow) {
      x -= 0.5D;
      y -= 0.5D;
    } 
    x--;
  ...
  private void setupBoldItalicIDs() {
    this
      .texBold = setupTexture(this.font
        .deriveFont(1), this.antiAlias, this.fractionalMetrics, this.boldChars);
    this
      .texItalic = setupTexture(this.font
        .deriveFont(2), this.antiAlias, this.fractionalMetrics, this.italicChars);
    this
      .texItalicBold = setupTexture(this.font
        .deriveFont(3), this.antiAlias, this.fractionalMetrics, this.boldItalicChars);
  }
